...
$(function () {
    $(".doughnutSummaryNumber")[0].innerHTML = "25";
    $(".doughnutSummaryNumber")[1].innerHTML = "32";
    $(".doughnutSummaryNumber")[2].innerHTML = "40";
    $(".doughnutSummaryNumber")[3].innerHTML = "35";
    $(".doughnutSummaryNumber")[4].innerHTML = "10";
});
